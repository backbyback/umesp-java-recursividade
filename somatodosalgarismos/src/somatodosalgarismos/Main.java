...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblExibir.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
    ...
    int somaAlgarismos(int numero) {
        if (numero == 0) {
            System.out.println("Soma de todos algarismo de 1234 = " + mod);
            return 0;
        } else {
            mod += numero % 10;
            return numero + somaAlgarismos(numero / 10);
        }
    }
